...
public class PermintaanVerifResponse implements Parcelable {
	...
	protected PermintaanVerifResponse(Parcel in) {
	...
	public static final Creator<PermintaanVerifResponse> CREATOR = new Creator<PermintaanVerifResponse>() {
		@Override
		public PermintaanVerifResponse createFromParcel(Parcel in) {
			return new PermintaanVerifResponse(in);
		}

		@Override
		public PermintaanVerifResponse[] newArray(int size) {
			return new PermintaanVerifResponse[size];
		}
	};
