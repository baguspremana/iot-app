...
public class SaldoVerifResponse implements Parcelable {
	...
	protected SaldoVerifResponse(Parcel in) {
		weight = in.readInt();
	...
	public static final Creator<SaldoVerifResponse> CREATOR = new Creator<SaldoVerifResponse>() {
		@Override
		public SaldoVerifResponse createFromParcel(Parcel in) {
			return new SaldoVerifResponse(in);
		}

		@Override
		public SaldoVerifResponse[] newArray(int size) {
			return new SaldoVerifResponse[size];
		}
	};
